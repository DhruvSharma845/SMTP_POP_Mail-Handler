...
public class ThreadedSMTPServer
{
	...
	public static void main(String[] args)
	{
		try
		{
			ServerSocket serv_sock=new ServerSocket(59417,LISTENQ);
			...
			while(true)
			{
				...
				ThreadedSMTPServerHandler newThreadServer=new ThreadedSMTPServerHandler(incoming_sock,serv_sock.getInetAddress().getHostAddress());
