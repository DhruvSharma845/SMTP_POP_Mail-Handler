...
public class ThreadedPOPServer
{
	...
	public static void main(String[] args)
	{
		try
		{
			ServerSocket serv_sock=new ServerSocket(59517,LISTENQ);
			...
			while(true)
			{
				...
				ThreadedPOPServerHandler newThreadServer=new ThreadedPOPServerHandler(incoming_sock,serv_sock.getInetAddress().getHostAddress());
